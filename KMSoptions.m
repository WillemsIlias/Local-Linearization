...
KMSoptions.EAM_maxit    = 100;               % maximum # of iterations for EAM steps     (Program may terminate early if too small, e.g. less than 20).
...
KMSoptions.EI_multi_num = 80;               % Maximum number of initial points to use in multi start.  (Smaller = faster, but more sensitive.  Recommend values in [10,100]).
...
KMSoptions.BCS_EAM      = 0;                                              % Set it equal to 1 if you use EAM applied to BCS prifiling.
KMSoptions.LL_EAM       = 0;
