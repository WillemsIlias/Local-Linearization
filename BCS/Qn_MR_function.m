...
function value = Qn_MR_function(theta_to_min,theta_H0,coordinate,data,kappa,p,k,W2_AA,MR_type,DGP)
...
n = size(data,1);
[~,mData,xi] = dataOperations_function(theta,data,kappa,DGP);
q = W2_AA*zscore(mData,1)/sqrt(n);
