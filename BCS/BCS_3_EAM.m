function [lambda_hat,lambda_optbound,c,CV,EI,flag_opt,lambda_feas_out] =  BCS_3_EAM(q,sgn_q,lambda_feas,lambda_Estep,c_Estep,...
    CV_Estep,maxviol_Estep,lambda_init,c_init,CV_init,maxviol_init,f_ineq,f_eq,f_ineq_keep,f_eq_keep,f_stdev_ineq,f_stdev_eq,G_ineq,G_eq,KMSoptions)
...
for iter=1:EAM_maxit
    ...
    % feasible search gaurantees that such a point exists (namely, lambda_feas.
